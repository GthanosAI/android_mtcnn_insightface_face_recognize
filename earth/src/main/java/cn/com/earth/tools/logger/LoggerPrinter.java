...
import static cn.com.earth.tools.logger.Logger.ASSERT;
import static cn.com.earth.tools.logger.Logger.DEBUG;
import static cn.com.earth.tools.logger.Logger.ERROR;
import static cn.com.earth.tools.logger.Logger.INFO;
import static cn.com.earth.tools.logger.Logger.VERBOSE;
import static cn.com.earth.tools.logger.Logger.WARN;
...
class LoggerPrinter implements Printer {
  ...
  @Override public void d(Object object) {
    log(DEBUG, null, LUtils.toString(object));
  }
  ...
  @Override public synchronized void log(int priority, String tag, String message, Throwable throwable) {
    if (throwable != null && message != null) {
      message += " : " + LUtils.getStackTraceString(throwable);
    }
    if (throwable != null && message == null) {
      message = LUtils.getStackTraceString(throwable);
    }
    if (LUtils.isEmpty(message)) {
